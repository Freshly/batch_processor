  ...
  module Batch
    module Callbacks
      ...
      included do
        ...
        define_callbacks_with_handler :job_started, :job_retried, :job_performed, :job_canceled,
                                      :batch_started, :batch_enqueued, :batch_aborted,
                                      :batch_finished, :batch_success, :batch_errored, :batch_completed
      end
